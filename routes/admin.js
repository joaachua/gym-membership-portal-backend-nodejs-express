...
router.post("/ads/upload-file", authorize(['Ads Management-Create']), upload.single('file'), AdsController.uploadFile);
...
router.post("/class/upload-file", authorize(['Class Management-Create']), upload.single('file'), ClassController.uploadFile);
...
router.post("/centre/upload-file", authorize(['Centre Management-Create']), upload.single('file'), CentreController.uploadFile);
